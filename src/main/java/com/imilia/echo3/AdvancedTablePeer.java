 ...
 * @author n.beekman
 */
public class AdvancedTablePeer extends AbstractComponentSynchronizePeer {

    /** The associated client-side JavaScript module <code>Service</code>. */
    private static final Service TABLE_SERVICE = JavaScriptService.forResource("Echo.AdvancedTable", 
            "js/AdvancedTable.js");
...
//        WebContainerServlet.getResourceRegistry().add("Echo", "resource/Handle.png", ContentType.IMAGE_PNG);
    ...
    public AdvancedTablePeer() {
        ...
        addEvent(new AbstractComponentSynchronizePeer.EventPeer(AdvancedTable.INPUT_ACTION, AdvancedTable.ACTION_LISTENERS_CHANGED_PROPERTY) {
            public boolean hasListeners(Context context, Component component) {
                return ((AdvancedTable) component).hasActionListeners();
            }
        });
    }
    ...
    public Object getOutputProperty(Context context, Component component, String propertyName, int propertyIndex) {
        AdvancedTable table = (AdvancedTable)component;
        ...
        } else if (AdvancedTable.PROPERTY_VERTICAL_LINE.equals(propertyName)) {
            return StrokePeer.toString(((AdvancedTable)component).getVerticalLine());
        } else if (AdvancedTable.PROPERTY_HORIZONTAL_LINE.equals(propertyName)) {
            return StrokePeer.toString(((AdvancedTable)component).getHorizontalLine());
        }
    ...
    public Iterator getOutputPropertyIndices(Context context, Component component, String propertyName) {
        if (PROPERTY_COLUMN_WIDTH.equals(propertyName)) {
            final Iterator columnIterator = ((AdvancedTable) component).getColumnModel().getColumns();
            return new Iterator() {
                private int i = 0;
    ...
    public Iterator getUpdatedOutputPropertyNames(Context context, Component component, 
        ...
        if (update.hasUpdatedProperty(AdvancedTable.MODEL_CHANGED_PROPERTY) || update.hasAddedChildren() || update.hasRemovedChildren()) {
    ...
    public void storeInputProperty(Context context, Component component, String propertyName, int index, Object newValue) {
        if (PROPERTY_SELECTION.equals(propertyName)) {
            ...
            clientUpdateManager.setComponentProperty(component, AdvancedTable.SELECTION_CHANGED_PROPERTY, selection);
        }
    }
}
